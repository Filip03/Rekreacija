...
CREATE TABLE `obavjestenja` (
  ...
  `title` text,
  `description` text,
  `type` enum('upravnik','pozajmica') DEFAULT NULL,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_update_loan_rating_after_update` AFTER INSERT ON `ocjena` FOR EACH ROW BEGIN
        UPDATE pozajmica
        SET rating = NEW.overall
...
-- Dump completed on 2025-04-02 17:18:07
